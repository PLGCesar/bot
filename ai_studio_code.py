...
def salvar_senha_admin(senha: str) -> bool:
    ...
    # Grava localmente também (como cache e fallback de testes)
    try:
...
@bot.tree.command(name="registrar-config", description="Define as permissões globais de quem pode registrar membros neste servidor.")
